cmd_scripts/mod/modpost.o := clang -Wp,-MD,scripts/mod/.modpost.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -Wno-deprecated-declarations      -c -o scripts/mod/modpost.o scripts/mod/modpost.c

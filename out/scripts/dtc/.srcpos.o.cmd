cmd_scripts/dtc/srcpos.o := clang -Wp,-MD,scripts/dtc/.srcpos.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -Wno-deprecated-declarations  -I../scripts/dtc  -I../scripts/dtc/libfdt -c -o scripts/dtc/srcpos.o ../scripts/dtc/srcpos.c

cmd_scripts/dtc/flattree.o := clang -Wp,-MD,scripts/dtc/.flattree.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -Wno-deprecated-declarations  -I../scripts/dtc  -I../scripts/dtc/libfdt -c -o scripts/dtc/flattree.o ../scripts/dtc/flattree.c

cmd_scripts/dtc/checks.o := clang -Wp,-MD,scripts/dtc/.checks.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -Wno-deprecated-declarations  -I../scripts/dtc  -I../scripts/dtc/libfdt -c -o scripts/dtc/checks.o ../scripts/dtc/checks.c

cmd_arch/arm/kernel/swp_emulate.o := clang -Wp,-MD,arch/arm/kernel/.swp_emulate.o.d -nostdinc -isystem /workspaces/toolchain/toolchain/clang/lib64/clang/11.0.1/include -I./arch/arm/include -I./arch/arm/include/generated  -I./drivers/misc/mediatek/include -I./include -I./arch/arm/include/uapi -I./arch/arm/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -D__KERNEL__ -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -Werror-implicit-function-declaration -Wno-format-security -std=gnu89 --target=arm-linux-androideabi --prefix=/workspaces/toolchain/toolchain/gcc/bin/arm-linux-androideabi- --gcc-toolchain=/workspaces/toolchain/toolchain/gcc -no-integrated-as -Werror=unknown-warning-option -fno-PIE -fno-dwarf2-cfi-asm -fno-omit-frame-pointer -mabi=aapcs-linux -mfpu=vfp -meabi gnu -marm -Wa,-mno-warn-deprecated -D__LINUX_ARM_ARCH__=7 -march=armv7-a -msoft-float -Uarm -fno-delete-null-pointer-checks -Wno-int-in-bool-context -Wno-address-of-packed-member -Os -DCC_HAVE_ASM_GOTO -Wframe-larger-than=1500 -fstack-protector-strong -Wno-format-invalid-specifier -Wno-gnu -Wno-duplicate-decl-specifier -Wno-tautological-compare -mno-global-merge -Wno-unused-const-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -g -Wdeclaration-after-statement -Wno-pointer-sign -Wno-array-bounds -fno-strict-overflow -fno-merge-all-constants -fno-stack-check -Werror=implicit-int -Werror=strict-prototypes -Werror=date-time -Werror=incompatible-pointer-types -fmacro-prefix-map=./= -Wno-initializer-overrides -Wno-unused-value -Wno-format -Wno-sign-compare -Wno-format-zero-length -Wno-uninitialized -w -DCONFIG_CC_IS_CLANG -I./drivers/misc/mediatek/mtprof/ -I./drivers/misc/mediatek/include/ -Wa,-march=armv7-a    -DKBUILD_BASENAME='"swp_emulate"'  -DKBUILD_MODNAME='"swp_emulate"' -c -o arch/arm/kernel/.tmp_swp_emulate.o arch/arm/kernel/swp_emulate.c
